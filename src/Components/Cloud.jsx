...
export default function Cloud() {
  ...
  return (
    <div className="cloud" data-aos="fade-up">
      <h2>
      ...
      <div className="cloud-elements">
        {cloud.map((obj) => (
          <div key={obj.id} data-aos="fade-zoom-in">
      ...
      <div className="cloud-elements2" data-aos="fade-up">
        ...
        <div style={{ backgroundImage: "url('Images/img2.png')" }}>
          <div>
            <h3>FOR STUDENTS</h3>
            <button style={{ backgroundColor: "rgba(35, 189, 238, 0.90)" }}>
              Enter access code
            </button>
          </div>
        </div>
      ...
      <div className="cloud-box" data-aos="fade-up">
