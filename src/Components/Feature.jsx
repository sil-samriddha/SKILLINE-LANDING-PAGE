...
export default function Feature() {
  ...
  return (
    <div className="feature">
      ...
      <div className="feature-head" data-aos="fade-up">
        ...
        <div className="feature-head-text">
          ...
          <div>
            <div>
              <img src="Icons/feature_icon1.svg" alt="-" />
            </div>
            <p>
            ...
            <div>
              <img src="Icons/feature_icon2.svg" alt="-" />
            </div>
            <p>TA's and presenters can be moved to the front of the class.</p>
            <div>
              <img src="Icons/feature_icon3.svg" alt="-" />
            </div>
            <p>
              ...
              <div key={feature.id} data-aos="fade-up">
                <div className="feature-elements-text">
                  <h1>
                    ...
                    <span>{feature.title.split("<span>")[1]}</span>
